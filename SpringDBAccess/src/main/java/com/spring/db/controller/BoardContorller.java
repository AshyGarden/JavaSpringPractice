...
// + Annotation(클래스 윗부분에 @RequiredArgsConstructor)(후 2번)
public class BoardContorller {
	
	@Autowired
	private IBoardService service;
	//또는
	//private final IBoardService service; (1번)
	...
	public String write(BoardVO vo) {
		System.out.println("POST: 글 작성 요청");
	...
	public void content(int boardNo, Model model) {
    	System.out.println("글 내용 상세보기 요청");
		model.addAttribute("article",service.selectContent(boardNo));
	}
